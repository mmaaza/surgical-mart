...
// Social Settings API (admin)
export const getSocialSettings = async () => {
    try {
        const response = await api.get('/admin/settings/social');
        return response.data;
    } catch (error) {
        throw error.response?.data || { error: 'Failed to fetch social settings' };
    }
};

export const updateSocialSettings = async (socialData) => {
    try {
        const response = await api.post('/admin/settings/social', socialData);
        return response.data;
    } catch (error) {
        throw error.response?.data || { error: 'Failed to update social settings' };
    }
};
