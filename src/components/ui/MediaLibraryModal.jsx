            ...
            <div className={view === "grid" 
              ...
              {mediaItems.length === 0 && (
                <div className="col-span-full flex flex-col items-center justify-center py-12 px-4">
                  <svg className="w-16 h-16 text-admin-slate-300 dark:text-admin-slate-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <p className="text-admin-slate-600 dark:text-admin-slate-400 font-medium mb-2">No media items yet</p>
                  <p className="text-admin-slate-500 dark:text-admin-slate-500 text-sm text-center">Click the upload button above to add your first image</p>
                </div>
              )}
            </div>
          </div>
